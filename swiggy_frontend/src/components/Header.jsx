...
function Header(){
    ...
    return(
        <div className=" bg-gray-900 text-white flex justify-between items-center px-12 py-4">
            ...
            <ul className="flex">
                <div className="flex items-center justify-center">
                    ...
                    <li className="mx-6">Offers</li>
                    </Link>
                </div>
                <div className="flex">
                    <Link to={'/help'}>
                    <span> <IoHelpBuoyOutline /> </span>
                    <li className="mx-6">Help</li>
                    </Link>
                </div>
                <div className="flex">
                    <Link to={'/signIn'}>
                    <span> <CgProfile /> </span>
                    <li className="mx-6">Signin</li>
                    </Link>
                </div>
                <div className="flex">
                    <Link to={"/carts"}>
